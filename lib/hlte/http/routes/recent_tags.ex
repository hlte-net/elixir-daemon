defmodule HLTE.HTTP.Route.RecentTags do
  require Logger
  ...
  def get_json(req, state) do
    ...
    # Use the TagsDB module to get recent tags
    tagsRes = HLTE.TagsDB.get_recent_tags(limit)
    
    elTime = :erlang.monotonic_time(:millisecond) - t0
    Logger.info("Executed recent tags query (limit=#{limit}) in #{elTime}ms")
